...
';
    ...
    {
        /*echo "<pre>";print_r('in getbodyrec');echo "</pre>";

        echo "<pre>";print_r('$funcname');echo "</pre>";
        echo "<pre>";print_r($funcname);echo "</pre>";
...
';
	...
	';
        ...
        /*echo "<pre>";print_r('end $bodyrec');echo "</pre>";
        echo "<pre>";print_r($bodyrec);echo "</pre>";*/
    ...
    protected function makeRequest($funcname,$param,$nameclient,$address)
    {
        ...
        /*echo "<pre>";print_r('in makeRequest');echo "</pre>";
        echo "<pre>";print_r('$funcname');echo "</pre>";
        echo "<pre>";print_r($funcname);echo "</pre>";
        echo "<pre>";print_r('$param');echo "</pre>";
        echo "<pre>";print_r($param);echo "</pre>";
        echo "<pre>";print_r($nameclient);echo "</pre>";
        ...
        else
        {
            ...
            /*
            echo "<pre>";print_r('$this->serv_addr.$address');echo "</pre>";
            echo "<pre>";print_r($this->serv_addr.$address);echo "</pre>";
            echo "<pre>";print_r('$arrHeader');echo "</pre>";
            echo "<pre>";print_r($arrHeader);echo "</pre>";
            echo "<pre>";print_r('curl - CURLOPT_POSTFIELDS - $xml');echo "</pre>";
           ...
           /* echo "<pre>";print_r('curl $lerror');echo "</pre>";
            echo "<pre>";print_r($lerror);echo "</pre>";*/
...
",$arrHeader)."\r\n\r\n".$xml;
                ...
                /*echo "<pre>";print_r('$this->LastReq');echo "</pre>";
                echo "<pre>";print_r($this->LastReq);echo "</pre>";*/
    ...
    {
        /*echo "<pre>";print_r('in GetSOAP');echo "</pre>";
        echo "<pre>";print_r($funcname);echo "</pre>";
        echo "<pre>";print_r($param);echo "</pre>";*/
    ...
    protected function GroupSMS($xml)
    {
        ...
        /*echo "<pre>";print_r('$xml in GroupSMS');echo "</pre>";
        echo "<pre>";print_r($xml);echo "</pre>";*/
...
*/
    ...
    public function SendSmsPack($message, $to, $sender = '', $startUp_p='', $dateActual_p='', $period_p = '')
    {
        ...
        if (count($sms_package) < $this->maxPackage)
        {
			...
			//echo "<pre>";print_r('in SendSmsPack count($sms_package) < $this->maxPackage');echo "</pre>";
        ...
        else
        {
            ...
            foreach($big_array as $arIndex)
            {
               ...
               /* echo "<pre>";print_r('$temp - $results_of_package_send');echo "</pre>";
                echo "<pre>";print_r($temp);echo "</pre>";

                AddMessage2Log('$temp - $results_of_package_send');
                AddMessage2Log($temp);*/
